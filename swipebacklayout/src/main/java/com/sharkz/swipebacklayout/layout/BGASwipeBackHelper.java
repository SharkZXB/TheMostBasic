...
package com.sharkz.swipebacklayout.layout;
...
import com.sharkz.swipebacklayout.R;
...
public class BGASwipeBackHelper {
    ...
    public static void executeForwardAnim(Activity activity) {
        activity.overridePendingTransition(R.anim.swipebacklayout_bga_sbl_activity_forward_enter, R.anim.swipebacklayout_bga_sbl_activity_forward_exit);
    }
    ...
    public static void executeBackwardAnim(Activity activity) {
        activity.overridePendingTransition(R.anim.swipebacklayout_bga_sbl_activity_backward_enter, R.anim.swipebacklayout_bga_sbl_activity_backward_exit);
    }
    ...
    public static void executeSwipeBackAnim(Activity activity) {
        activity.overridePendingTransition(R.anim.swipebacklayout_bga_sbl_activity_swipeback_enter, R.anim.swipebacklayout_bga_sbl_activity_swipeback_exit);
    }

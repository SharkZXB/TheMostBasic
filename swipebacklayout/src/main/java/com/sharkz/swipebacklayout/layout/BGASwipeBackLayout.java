...
public class BGASwipeBackLayout extends ViewGroup {
     ...
     * This indicates that there is webview_more content available and provides
...
//        mOverhangSize = (int) (DEFAULT_OVERHANG_SIZE * density + 0.5f);
    ...
    void updateObscuredViewsVisibility(View panel) {
        ...
        for (int i = 0, childCount = getChildCount(); i < childCount; i++) {
            ...
            if (child == panel) {
                // There are still webview_more children above the panel but they won't be affected.
                break;
...
//        int heightSize = MeasureSpec.getSize(heightMeasureSpec);
     ...
     * the content pane can be slid webview_back and forth.
     *
     * @return true if content in this layout can be slid open and closed
     */
